...
const resources = {
  en: {
    translation: {
      ...
      auth: {
        login_title: 'LLMAPI Usage Statistics Dashboard',
        login_subtitle: '',
      ...
      usage_stats: {
        ...
        tutorial_link: 'View usage guide',
        daily_quota_daily_refresh_label: 'Daily refresh balance',
        daily_quota_pay_as_you_go_label: 'Pay-as-you-go balance',
        daily_quota_loading: 'Loading...',
        daily_quota_failed: 'Query failed',
        ...
        api_key_settings_subtitle: 'Review synced CPA API keys without exposing the full key.',
        api_key_settings_empty: 'No CPA API keys synced yet.',
        api_key_settings_id: 'Local ID',
        api_key_settings_display_key: 'API Key',
        api_key_settings_alias: '',
        api_key_settings_saving: '',
        ...
        model_info_available_eyebrow: 'Models',
        model_info_available_title: 'codex可用模型',
        model_info_available_subtitle: '',
        model_info_available_empty_title: 'No Available Models',
        model_info_available_empty_desc: 'Configure AVAILABLE_MODELS_BASE_URL and AVAILABLE_MODELS_API_KEY to load available models.',
        model_info_pricing_eyebrow: 'Pricing',
        model_info_pricing_title: 'codex可用模型价格表',
        model_info_pricing_subtitle: 'Missing prices default to 0.',
        model_info_pricing_empty_title: 'No Model Prices',
        model_info_pricing_empty_desc: 'Model prices will appear here after they are written to app.db.',
        model_info_query_eyebrow: 'Lookup',
        model_info_query_title: 'Oh My GPT额度与可用模型查询',
        model_info_query_subtitle: 'Codex的额度是共享的，这里只能查询自己的Oh My GPT额度。可点击顶部使用教程按钮查看详情。',
        model_info_query_input_label: 'API Key',
        model_info_query_input_placeholder: '请输入你的API KEY',
        model_info_query_button: '查询',
        model_info_query_failed: 'Query failed',
        ...
        analysis_api_key_cost_composition_title: 'API Key Cost Share',
  ...
  zh: {
    translation: {
      ...
      usage_stats: {
        ...
        last_updated: '最近更新',
        tutorial_link: '点击查看使用教程',
        daily_quota_daily_refresh_label: '每日刷新余额',
        daily_quota_pay_as_you_go_label: '按量计费余额',
        daily_quota_loading: '加载中...',
        daily_quota_failed: '查询失败',
        back_to_cpa: '返回CPA',
        ...
        api_key_settings_subtitle: '查看已同步的 CPA API Key，前端不会暴露完整 API Key。',
        ...
        model_info_available_eyebrow: '模型',
        model_info_available_title: 'codex可用模型',
        model_info_available_subtitle: '',
        model_info_available_empty_title: '暂无可用模型',
        model_info_available_empty_desc: '配置 AVAILABLE_MODELS_BASE_URL 和 AVAILABLE_MODELS_API_KEY 后会加载可用模型。',
        model_info_pricing_eyebrow: '价格',
        model_info_pricing_title: 'codex可用模型价格表',
        model_info_pricing_subtitle: '缺失价格默认显示 0。',
        model_info_pricing_empty_title: '暂无模型价格',
        model_info_pricing_empty_desc: '后续写入 app.db 后会在这里显示模型价格。',
        model_info_query_eyebrow: '查询',
        model_info_query_title: 'Oh My GPT额度与可用模型查询',
        model_info_query_subtitle: 'Codex的额度是共享的，这里只能查询自己的Oh My GPT额度。可点击顶部使用教程按钮查看详情。',
        model_info_query_input_label: 'API Key',
        model_info_query_input_placeholder: '请输入你的API KEY',
        model_info_query_button: '查询',
        model_info_query_failed: '查询失败',
        ...
        analysis_api_key_cost_composition_title: 'API Key 成本占比',
  ...
  'zh-TW': {
    translation: {
      ...
      usage_stats: {
        ...
        last_updated: '最近更新',
        tutorial_link: '點擊查看使用教程',
        daily_quota_daily_refresh_label: '每日重新整理餘額',
        daily_quota_pay_as_you_go_label: '按量計費餘額',
        daily_quota_loading: '載入中...',
        daily_quota_failed: '查詢失敗',
        back_to_cpa: '返回CPA',
        ...
        api_key_settings_subtitle: '查看已同步的 CPA API Key，前端不會暴露完整 API Key。',
        ...
        model_info_available_title: 'codex可用模型',
        model_info_available_subtitle: '',
        model_info_available_empty_title: '尚無可用模型',
        model_info_available_empty_desc: '設定 AVAILABLE_MODELS_BASE_URL 和 AVAILABLE_MODELS_API_KEY 後會載入可用模型。',
        model_info_pricing_eyebrow: '價格',
        model_info_pricing_title: 'codex可用模型价格表',
        model_info_pricing_subtitle: '缺少價格預設顯示 0。',
        model_info_pricing_empty_title: '尚無模型價格',
        model_info_pricing_empty_desc: '後續寫入 app.db 後會在這裡顯示模型價格。',
        model_info_query_eyebrow: '查詢',
        model_info_query_title: 'Oh My GPT额度与可用模型查询',
        model_info_query_subtitle: 'Codex的额度是共享的，这里只能查询自己的Oh My GPT额度。可点击顶部使用教程按钮查看详情。',
        model_info_query_input_label: 'API Key',
        model_info_query_input_placeholder: '请输入你的API KEY',
        model_info_query_button: '查询',
        model_info_query_failed: '查詢失敗',
